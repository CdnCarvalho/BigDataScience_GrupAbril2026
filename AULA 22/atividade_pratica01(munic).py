...
try:
    ...
    plt.text(0.05, 0.9, f'Média: {media}', fontsize=10)
    plt.text(0.05, 0.8, f'Mediana: {mediana}', fontsize=10)
    plt.text(0.05, 0.7, f'Distância: {distancia_media_mediana:.2f}', fontsize=10)
    plt.text(0.05, 0.6, f'Mínimo: {minimo}', fontsize=10)
    plt.text(0.05, 0.5, f'Q1: {q1}', fontsize=10)
    plt.text(0.05, 0.4, f'Q3: {q3}', fontsize=10)
    plt.text(0.05, 0.3, f'IQR: {iqr}', fontsize=10)
    plt.text(0.05, 0.2, f'Máximo: {maximo}', fontsize=10)
    plt.text(0.05, 0.1, f'Amplitude: {amplitude_total}', fontsize=10)

    # Desvio padrão, distância, coeficiente de variação e variância
    plt.text(0.6, 0.9, f'Desvio Padrão: {desvio_padrao}', fontsize=10)
    plt.text(0.6, 0.8, f'Variância: {variancia}', fontsize=10)
    plt.text(0.6, 0.7, f'Coeficiente de Variação: {coef_variacao}', fontsize=10)
    plt.text(0.6, 0.6, f'Dist. Var x Média: {distancia_var_media}', fontsize=10)
