...
try:
    ...
    # ===================================================
    # POSIÇÃO 2 - MEDIDAS ESTATÍSTICAS
    # ===================================================
    plt.subplot(2, 2, 2)
    ...
    # Abreviar os nomes, se precisar
    plt.bar(df_roubo_veiculo_outliers_superiores['munic'].str.slice(0, 10), df_roubo_veiculo_outliers_superiores['roubo_veiculo'])
    ...
    plt.xticks(rotation=45, ha='right') # rotaciona os rótulos dos eixos x
    plt.title('Top 10 - Outliers dos maiores roubos')
