...
try:
    ...
    # Quntidade de municipios
    qtd_municipios = len(array_roubo_veiculo)
    print('\nQuantidade de municípios:')
    print(30*'-')
    print(f'Quantidade: {qtd_municipios}')
...
try:
    ...
    #  valores estão equilibrados em torno do centro?
    #  Há concentração maior em um lado do centro?  O “peso” está mais para valores menores ou maiores?
    #  Ela é uma medida que descreverá o quanto uma distribuição é simétrica ou assimétrica
    # 
    #  Quanto mais próximo de 0 (-0.5 a 0.5) mais simétrica é a distribuição. Os dados estão distribuídos 
    #  de forma homogênea ao redor da média

    #  Acima de 0.5, a assimetria é positiva, a maior parte dos dados está concentrada nos valores mais baixos, 
    #  enquanto poucos valores elevados formam uma cauda à direita. Os dados maiores estão puxando a média
    #  para cima. Tende a ser maior que a mediana
    #  0.5 a 1.0 é uma assimetria moderada. 
    
    #  Assimetria acima 1.0 é uma assimetria alta
    #  Abaixo de -0.5, a assimetria é negativa, a maior parte dos dados estão mais concentrados nos 
    #  valores mais altos da distribuição. Os dados menores estão puxando a média para baixo. Os valores menores 
    #  formam a cauda à esquerda. Média Tende a ser menor que a mediana
    #  
    #  -0.5 a -1.0 é uma assimetria moderada. 
    ...
    #curtpse. Kurtosis
    # Curtose explica o formato da distribuição em torno do centro
    # como os dados se concentram perto da média e o peso dos valores extremos (outliers).
    # mede “pico” e “extremos” da distribuição
    ...
    # Simetria Direção do desequilíbrio Esquerda × Direita “Para que lado pende?” 
    # Curtose Concentração e extremos Centro e caudas “Quão pontudo ou extremo?” 
...
# Moda
try:
    # moda_pandas = df_roubo_veiculo['roubo_veiculo'].mode()
    print('\nModa (Pandas):')
    print(30*'-')
    frequencias = df_roubo_veiculo['roubo_veiculo'].value_counts()
    print(frequencias.head())
...
try:
    ...
    plt.subplot(2, 2, 2)
    # ESCOLHER ENTRE OS OUTLIERS SUPERIORES OU O TOP 10    
    ...
    # --- POSIÇÃO 3: Colunas com os municípios de menores roubos
    plt.subplot(2, 2, 3)
