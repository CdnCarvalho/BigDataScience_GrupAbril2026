...
# Carregando a planilha de vendas de uma loja de roupas
df_roupas = pd.read_excel('vendas_roupas.xlsx')


# Exibindo as 10 primeiras linhas da planilha
...
# ------------------------------------ ATIVIDADE 03 -----------------------------------------------------------
array_faturamento = np.array(df_roupas['Faturamento Total (R$)'])
...
# Achando os Quartis
q1 = np.quantile(array_faturamento, 0.25)  # 1º Quartil  25% 
q2 = np.quantile(array_faturamento, 0.5)  # 2º Quartil (Mediana) 50 %
q3 = np.quantile(array_faturamento, 0.75)  # 3º Quartil  75%
